...
function rz_custom_post_type() {
    $labels = array(
        ...
        'name_admin_bar'        => __( 'Post Type Review', 'text_domain' ),
    ...
    $args = array(
        ...
        'description'           => __( 'Review Type Description', 'text_domain' ),
        'labels'                => $labels,
        'supports'              => array( ),
...
add_action( 'init', 'rz_custom_post_type', 0 );
